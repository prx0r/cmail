...
const TLD_PRICING: Record<string, Record<string, { registration: number; renewal: number; privacy: number; promo?: string | null }>> = {
  ...
  io:     { porkbun: { registration: 44.99, renewal: 44.99, privacy: 0 }, cloudflare: { registration: 44.00, renewal: 44.00, privacy: 0 }, namecheap: { registration: 32.98, renewal: 32.98, privacy: 0 }, dynadot: { registration: 42.99, renewal: 42.99, privacy: 0 } },
  dev:    { porkbun: { registration: 14.99, renewal: 14.99, privacy: 0 }, cloudflare: { registration: 12.00, renewal: 12.00, privacy: 0 }, namecheap: { registration: 14.98, renewal: 14.98, privacy: 0 }, dynadot: { registration: 13.99, renewal: 13.99, privacy: 0 } },
  ai:     { porkbun: { registration: 89.99, renewal: 89.99, privacy: 0 }, cloudflare: { registration: 84.00, renewal: 84.00, privacy: 0 }, namecheap: { registration: 74.98, renewal: 74.98, privacy: 0 }, dynadot: { registration: 79.99, renewal: 79.99, privacy: 0 } },
  ...
  app:    { porkbun: { registration: 14.99, renewal: 14.99, privacy: 0 }, cloudflare: { registration: 12.00, renewal: 12.00, privacy: 0 }, namecheap: { registration: 14.98, renewal: 14.98, privacy: 0 }, dynadot: { registration: 13.99, renewal: 13.99, privacy: 0 } },
  co:     { porkbun: { registration: 29.99, renewal: 29.99, privacy: 0 }, cloudflare: { registration: 30.00, renewal: 30.00, privacy: 0 }, namecheap: { registration: 9.98, renewal: 29.98, privacy: 0 }, dynadot: { registration: 27.99, renewal: 27.99, privacy: 0 } },
